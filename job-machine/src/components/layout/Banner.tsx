...
const Banner = () => {
  return (
    <Flex vertical gap="30px">
      ...
      <Flex gap={10}>
          <BaseSelect defaultValue="Move to trash" allowClear style={{height: '40px', width: '130px'}}>
          ...
          <BaseSelect defaultValue="All dates" allowClear style={{height: '40px', width: '110px'}}>
